export default function Home() {
  return (
    <>
      ...
      including versions of Lorem Ipsum. Why do we use it? It is a long established fact that a
      ...
      on purpose (injected humour and the like). Where does it come from? Contrary to popular
      ...
      non-characteristic words etc. Lorem Ipsum is simply dummy text of the printing and typesetting
      ...
      by accident, sometimes on purpose (injected humour and the like). Where does it come from?
      ...
      amet..&quot;, comes from a line in section 1.10.32. The standard chunk of Lorem Ipsum used
      ...
      original form, accompanied by English versions from the 1914 translation by H. Rackham. Where
      can I get some? There are many variations of passages of Lorem Ipsum available, but the
      ...
      humour, or non-characteristic words etc. Lorem Ipsum is simply dummy text of the printing and
