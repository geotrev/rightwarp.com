...
export const Header = ({ theme }: { theme: string }) => {
  ...
  return (
    <header
      ref={ref}
      className="sticky top-[-1px] bg-base-200/50 px-8 py-2 backdrop-blur-lg transition-colors duration-300 sm:px-8 md:px-12 md:py-4 lg:rounded-t-3xl lg:px-24 lg:py-8"
    >
