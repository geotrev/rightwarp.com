...
export const Action = ({ children, heading, description, ...props }: ActionProps) => {
  return (
    <div {...props} className={classNames("flex flex-col gap-4", props.className)}>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        <h2 className="display text-xl leading-8 tracking-tight text-black sm:whitespace-nowrap sm:text-2xl sm:leading-10 dark:text-white">
          {heading}
        </h2>
