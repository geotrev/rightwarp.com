...
export const LogoMarquee = () => {
  ...
  return (
    ...
    >
      <div className="relative flex h-12 max-w-full items-center overflow-x-hidden text-purple-950 opacity-75 md:gap-3 lg:gap-12 dark:text-purple-100">
        {/* animation start */}
        <div
      ...
      <button
        type="button"
        className={cn("btn btn-ghost btn-xs me-auto ms-6 md:ms-12 lg:ms-24", {
      ...
      >
        ...
        {isPaused ? "Play scroll" : "Pause scroll"}
      </button>
    </section>
  )
}
