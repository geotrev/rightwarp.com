...
In January of this year, accessibility overlay provider accessiBe came under fire through the FTC for false advertising. This isn’t terribly surprising, considering:
...
– Kyle Wiggers, TechCrunch (source)
...
Around 2008, HTML5 entered the scene to give us more useful templating features. This enabled designers and developers to move away from div soup and into the wonderful world of semantic HTML, and combined with emerging CSS features like animations, our apps came to life well beyond what was ‘standard’ up to that point.
...
At the time, I was working at Scribd, who was going through an accessibility lawsuit of its own. I started in their engineering organization as one of the engineers tasked with remediating violations across its products and website.
...
Accessibility is hard work. Engineers, designers, and product managers tasked with remediating these issues aren’t looking for brownie points. A significant portion of internet users are blind, and our society demands dependence on the internet, so how can we do it right? Not with shortcuts.
