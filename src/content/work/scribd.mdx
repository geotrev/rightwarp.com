...
bodyIntro: >
  As a leader in document sharing, eBooks, and Audiobooks, Scribd wanted to
  expand its digital firepower with a more modern, friendly, and approachable
  brand presence.
---

<CallToAction href="https://web.archive.org/web/20190823043040/https://www.scribd.com/about" label="View Corporate Website (Archive)" />
...
In addition to building this website, full-time help was provided to modernize its Audiobook listening interface, eBook/Audiobook product pages, as well as highly performance document (PDF) page. The initial 5 months were spent working in digital product designer before transitioning full-time into software engineering.
